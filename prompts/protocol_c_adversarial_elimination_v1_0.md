...
- §"Features" — the 54-feature vector (v3.1 lines 439-496)
- §"DO NOT Rules" 1-11 (v3.1 lines 590-647)

The build step produces `prompts/protocol_c_adversarial_elimination_v1_0_pilot.md`
...
§"Buckets, Features, DO NOT Rules" of THIS file.
...
content if v3.x has evolved between v1.0 authoring and pilot dispatch.

**Build step ownership:** owner-gated. v1.0 makes the requirement
explicit; the actual `_pilot.md` build is a separate pipeline step
performed at pilot-dispatch time.

This requirement mirrors Protocol B v1.0.1 §"PRE-PILOT BUILD REQUIREMENT"
verbatim (intentionally — the build constraint is protocol-agnostic).
...
The bucket taxonomy, 54-feature vector + v2.4 P1 blocker features
(#56-#59), and DO NOT Rules 1-11 are inherited verbatim from
`prompts/gto_labeller_v3.1.md`. Protocol C's distinction is REASONING
ORDER, not bucket / feature / rule definitions. These are protocol-
agnostic and apply equally to A, B, C.

**The build step inlines these sections at pilot-dispatch time** (see
§"PRE-PILOT BUILD REQUIREMENT" above). For maintenance purposes the
references are:

- §"Bucket taxonomy" — v3.1 lines 170-204
- §"The 54-feature vector" — v3.1 lines 439-496 (54 v3.1 features +
  4 v2.4 P1 blocker features #56-#59 per `BUILDER_V24_P1_SPEC_LOCKED_2026-04-19.md`)
- §"DO NOT Rules" 1-11 — v3.1 lines 590-647

The six buckets are: **monster · strong_made · medium_made ·
weak_made · drawing · air**.

DO NOT Rules summary (full text per v3.1):
...
11. (HRP=0.00 test-harness artifact warning — see v3.1 §3.B.)
