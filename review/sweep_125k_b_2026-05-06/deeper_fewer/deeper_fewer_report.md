...
re: Phase 12.5K-B-pilot-deeper_fewer — v9 student trainer run (hybrid weighting; combined corpus)
status: BUILDER BLOCKED — 12.5K-B-pilot-deeper_fewer implementation + 5-seed run complete; gate did not promote; model NOT promoted
---

# Phase 12.5K-B-pilot-deeper_fewer — v9 student trainer report (hybrid weighting)

12.5K-B-pilot-deeper_fewer RUN COMPLETE; median seed below v9-3way-v2.2 baseline. Per dispatch gate threshold the model was NOT promoted. Section E quantifies the delta vs 12.5D baseline.

Master HEAD at run time: `bc7d08b3b6197bcad3f69fc29c42738db31570b8`. Run timestamp (UTC): `2026-05-07T00:08:01Z`.
...
```
prepad: bumped num_feature 45 → 61 → /tmp/prepad_v9_p_1ngxdo.json
```
...
|---|---|---|---|---|---|---|---|
|0|630|158|0.968|0.975|653|WARN|PASS|
|1|630|158|0.949|0.963|444|WARN|PASS|
|2|630|158|0.918|0.951|547|WARN|PASS|
|3|630|158|0.943|0.962|653|WARN|WARN|
|4|630|158|0.962|0.973|398|WARN|PASS|
|mean|—|—|0.948±0.018|0.965±0.009|—|—|—|
...
|CHECK|0.982|0.848|0.911|66|
|CALL|0.938|0.938|0.938|16|
|BET|0.767|0.971|0.857|34|
...
|---|---|---|
|`nut_flush_block`|0.0046|YES — FLAG|
|`flush_draw_block_pct`|0.0344|no|
|`straight_draw_block_pct`|0.0094|YES — FLAG|
|`nut_made_block_pct`|0.0164|no|
...
|`facing_bet`|0.0647|
|`is_monster`|0.0577|
|`equity_margin`|0.0538|
|`raw_equity`|0.0466|
|`flush_block_pct`|0.0431|
|`to_call`|0.0421|
|`equity_vs_range`|0.0405|
|`num_opponents`|0.0383|
|`improvement_probability`|0.0347|
|`flush_draw_block_pct`|0.0344|
|`better_hand_pct`|0.0287|
|`hand_category`|0.0237|
|`is_rainbow`|0.0232|
|`villain_draw_pct`|0.0217|
|`pot_odds`|0.0211|
...
|feature|importance|
|---|---|
|`high_card_rank`|0.0094|
|`straight_draw_block_pct`|0.0094|
|`has_straight_draw`|0.0085|
|`overcard_outs`|0.0079|
|`villain_range_capped`|0.0077|
|`flush_danger`|0.0064|
|`street`|0.0062|
|`is_paired`|0.0053|
|`has_flush_draw`|0.0052|
|`nut_flush_block`|0.0046|
|`connectivity_score`|0.0045|
|`straight_danger`|0.0044|
|`villain_call_count`|0.0042|
|`is_made_hand`|0.0000|
|`is_monotone`|0.0000|
...
|CHECK|0.939/0.939/0.939|0.982/0.848/0.911|-0.091|
|CALL|0.769/0.833/0.800|0.938/0.938/0.938|+0.105|
|BET|0.824/0.824/0.824|0.767/0.971/0.857|+0.147|
...
|---|---|---|---|
|`nut_flush_block`|0.0000|0.0046|+0.0046|
|`flush_draw_block_pct`|0.0107|0.0344|+0.0237|
|`straight_draw_block_pct`|0.0071|0.0094|+0.0023|
|`nut_made_block_pct`|0.0056|0.0164|+0.0108|
...
- Output model: `review/sweep_125k_b_2026-05-06/deeper_fewer/deeper_fewer_model.json` SHA256: `(no model promoted)`
...
**Status: 12.5K-B-pilot-deeper_fewer RUN COMPLETE; model NOT promoted (median seed below v9-3way-v2.2 baseline). 12.5E-F gate decides next direction. Awaiting QC pre-merge audit + ml-architect/gto-expert review.**
