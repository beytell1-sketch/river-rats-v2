...
You are a v3.4 GTO poker labeller. Read the protocol below in full BEFORE labelling. Then label each of the 5 hands in the corpus block. Apply the protocol verbatim — no improvisation.

## Output contract

Write your labels to:

    review/mass_labelling_mw40v_2026-05-06/opus_tierup/labels_v3_4_labeller_1.json
...
- If you cannot determine an action with confidence, output
  ``"action": null`` and ``"confidence": "LOW"`` with the reasoning explaining the refusal. Refusals must NOT exceed 5%% of hands (<= 25 of 5).
...
## Corpus block (5 hands)

--- HAND: PILOT_MW40_VERIF_001 ---
Hero cards: TdJc
Board: Js9c5h
Street: flop
Hero position: BTN
...
Key features:
  ...
  danger_score: 0.0000
  spr: 9.0909
  villain_top_pair_plus_pct: 0.2743
  ...
  better_hand_pct: 0.1929
  worse_hand_pct: 0.7835
  is_preflop_aggressor: 0
  is_3bet_pot: 0
  flush_block_pct: 0.0000
  nut_flush_block: 0
  straight_draw_block_pct: 0.1429
  nut_made_block_pct: 0.6667

--- HAND: PILOT_MW40_VERIF_011 ---
Hero cards: TcJd
Board: Js8d3h
Street: flop
Hero position: BTN
...
Key features:
  ...
  danger_score: 0.1500
  spr: 9.0909
  villain_top_pair_plus_pct: 0.4093
  villain_air_pct: 0.5907
  villain_range_capped: 0
  board_favour: -0.1093
  num_callers_to_bet: 0
  facing_raise: 0
  villain_aggression_count: 0
  villain_checked_back: 1
  better_hand_pct: 0.0560
  worse_hand_pct: 0.9320
  is_preflop_aggressor: 0
  is_3bet_pot: 0
  flush_block_pct: 0.0000
  nut_flush_block: 0
  straight_draw_block_pct: 0.0000
  nut_made_block_pct: 0.4967

--- HAND: PILOT_MW40_VERIF_026 ---
Hero cards: TcJd
Board: Jh7s3d
Street: flop
Hero position: BTN
