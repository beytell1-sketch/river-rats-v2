...
You are a v3.4 GTO poker labeller. Read the protocol below in full BEFORE labelling. Then label each of the 10 hands in the corpus block. Apply the protocol verbatim — no improvisation.

## Output contract

Write your labels to:

    review/mass_labelling_lever_c_fix_2026-05-07/pilot/labels_v3_4_labeller_2.json
...
- If you cannot determine an action with confidence, output
  ``"action": null`` and ``"confidence": "LOW"`` with the reasoning explaining the refusal. Refusals must NOT exceed 5%% of hands (<= 25 of 10).
