...
- **Hands to add:** 36 sampled to balance the new corpus's class distribution within ±15% of the existing 494-hand mix per class (see §4 sizing math). Specifically: 12 CHECK, 8 BET, 8 FOLD, 6 CALL, 2 RAISE controls
