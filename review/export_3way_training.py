...
def export_training_csv(input_path: str, output_path: str):
    ...
    with open(input_path) as f:
        for line in f:
            ...
            # Map expert 5-action vocabulary to oracle 3-action vocabulary.
            # Expert uses {CHECK, BET, CALL, FOLD, RAISE}.
            # Oracle/model uses {FOLD, CALL, RAISE}.
            # CHECK (not facing bet) → FOLD, BET (not facing bet) → RAISE.
