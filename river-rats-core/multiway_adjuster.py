...
def adjust(pred, feat_dict: dict, num_opponents: int,
    ...
    adjuster_enabled = p.get('adjuster_enabled', True)

    action = pred.action

    # Complete bypass — oracle prediction passes through unchanged
    if not adjuster_enabled:
